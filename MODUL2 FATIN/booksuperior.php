  ...
  <tr>
    ...
    <div class="form" action="mybooking.php" method="post">
      ...
      <table border="0" cellspacing="0" cellpadding="5">
        ...
        <tr>
          <td><input type="textbox" style="width: 450px;" name="nama"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><input type="text" id="room" style="width: 450px;" disabled placeholder="Superior" class="bg-light" name="roomtype"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><input type="checkbox" name="addservice"> Room Service</td>
        </tr>
        <tr>
          <td><input type="checkbox" name="addservice"> Breakfast</td>
        </tr>   
        <tr>
    ...
    <td>
      ...
      <!-- gambar -->
    <div>
      <img src="superior.jpg" style="width: 35rem;">
    </div>
      </td>
